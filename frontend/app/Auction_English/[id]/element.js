...
export default function English_Auction_Item() {
 ...
 function updateTimeLeft(endTime) {
  ...
  if (!auction) return <p className="text-center font-[Georgia] text-yellow-500 m-10">Loading...</p>;
...
{/* Timer */}
        ...
        {/* Bidding Section */}
          ...
          <button className="mt-4 w-full bg-yellow-600 text-white py-2 text-sm font-semibold  hover:bg-yellow-700" onClick={handleBid}>
          Place Bid </button>
          <input 
